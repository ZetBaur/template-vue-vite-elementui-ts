...
<script>
import Screen from '../../../node_modules/vnodes/src/components/Screen.vue';
import Node from '../../../node_modules/vnodes/src/components/Node.vue';
...
export default {
    ...
    methods: {
        ...
        createConnect(node, { input, output }) {
            console.log('createConnect', node);
...
#ports-demo .node .content {
    ...
    box-shadow: 2px 2px 2px 2px rgb(100, 100, 100, 0.5);
